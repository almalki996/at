...
export function GenericForm({ resource, action, id }: { resource: string, action: "create" | "edit", id?: string | number }) {
    ...
    return (
        <div className="w-full">
            ...
            <form onSubmit={handleSubmit(onSubmit)} className="space-y-6 max-w-4xl bg-white dark:bg-slate-900 p-8 rounded-3xl shadow-sm border border-gray-100 dark:border-slate-800 transition-colors mx-auto mt-6">
